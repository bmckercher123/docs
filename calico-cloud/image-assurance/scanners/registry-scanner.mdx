...
The registry scanner also supports authentication using AZURE and AWS credentials. If you use these credentials, the registry scanner can retrieve images that do not have tags associated with them. 
