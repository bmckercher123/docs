...
- [Setting up registry scanner](#set-up-registry-credentials)
...
The registry scanner comes in a docker image. Simply run `docker pull quay.io/tigera/image-assurance-registry-scanner:v1.10.4` in order to retrieve it.

### Setting up registry scanner
